...
| Idle                                 | Member auth                          |
| ------------------------------------ | ------------------------------------ |
| ![Idle screen](screenshots/idle.png) | ![auth screen](screenshots/auth.png) |

| Charging                                     | Complete                                           |
| -------------------------------------------- | -------------------------------------------------- |
| ![Charging screen](screenshots/charging.png) | ![Charging alert screen](screenshots/complete.png) |
