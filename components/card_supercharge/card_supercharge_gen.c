...
#include "card_supercharge_gen.h"
#include "../../lvpower.h"
...
lv_obj_t * card_supercharge_create(lv_obj_t * parent, const void * icon, const char * tier, const char * price, const char * detail, const char * unit)
{
    ...
    if (lvpower_check_target(LVPOWER_TARGET_ALL)) {
        ...
        lv_obj_set_name_static(card_0, "card_supercharge_#");
        ...
        lv_obj_set_style_text_color(label_1, CONST_ON_ACCENT_GLOBAL, 0);
        ...
        lv_obj_set_style_text_color(label_2, CONST_ACCENT_BRIGHT_GLOBAL, 0);
        ...
        lv_obj_set_style_text_color(label_4, CONST_TEXT_TERTIARY_GLOBAL, 0);
