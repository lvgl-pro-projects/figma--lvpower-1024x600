...
lv_obj_t * chip_card_create(lv_obj_t * parent, lv_style_t * tone, lv_style_t * tone_dot, lv_style_t * tone_label, const char * chip_text)
{
    ...
    if (lvpower_check_target(LVPOWER_TARGET_ALL)) {
        ...
        lv_obj_set_name_static(card_0, "chip_card_#");
        ...
        lv_label_set_text(label_0, chip_text);
