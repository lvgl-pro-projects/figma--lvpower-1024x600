...
lv_obj_t * icon_back_create(lv_obj_t * parent)
{
    ...
    if (lvpower_check_target(LVPOWER_TARGET_ALL)) {
        ...
        lv_obj_set_name_static(image_0, "icon_back_#");
        lv_obj_set_width(image_0, 24);
        lv_obj_set_height(image_0, 24);
        lv_image_set_src(image_0, image_icon_back_323661);
