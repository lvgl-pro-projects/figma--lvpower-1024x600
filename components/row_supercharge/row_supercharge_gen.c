...
lv_obj_t * row_supercharge_create(lv_obj_t * parent, const void * icon, const char * tier, const char * detail, const char * price, const char * unit, bool checked, bool pressed)
{
    ...
    if (!style_inited) {
        ...
        lv_style_set_bg_color(&style_desc_0_checked, CONST_ACCENT_BRIGHT_GLOBAL);
    ...
    if (lvpower_check_target(LVPOWER_TARGET_ALL)) {
        ...
        lv_obj_set_name_static(card_0, "row_supercharge_#");
        ...
        lv_obj_set_style_bg_color(card_0, CONST_TEXT_PRIMARY_GLOBAL, 0);
        ...
        lv_obj_set_style_text_color(label_1, CONST_TEXT_TERTIARY_GLOBAL, 0);
        lv_obj_add_style(label_1, &style_caption_global, 0);

        lv_obj_t * row_0 = row_create(card_0, 0, 0, 0, 0, 2, 0, LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_END);
        ...
        lv_obj_set_style_text_color(label_2, CONST_ON_ACCENT_GLOBAL, 0);
        ...
        lv_obj_set_style_text_color(label_3, CONST_ACCENT_BRIGHT_GLOBAL, 0);
        ...
        lv_obj_set_style_text_color(label_4, CONST_ACCENT_BRIGHT_GLOBAL, 0);
